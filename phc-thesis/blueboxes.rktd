2390
((3) 0 () 3 ((q lib "phc-adt/tagged-structure-low-level.hl.rkt") (q lib "phc-graph/flexible-with-utils.hl.rkt") (q 1466 . 3)) () (h ! (equal) ((c form c (c (? . 0) q merge/type)) q (4709 . 4)) ((c form c (c (? . 0) q merge)) q (4577 . 4)) ((c def c (c (? . 1) q floor-log2)) q (1280 . 3)) ((c form c (c (? . 0) q λ-tagged-get-field)) q (3891 . 3)) ((c form c (c (? . 0) q tagged-match!)) q (3036 . 9)) ((c def c (c (? . 1) q from-bits)) q (1194 . 3)) ((q form ((lib "phc-graph/traversal.hl.rkt") define-fold)) q (0 . 3)) ((c form c (c (? . 0) q has-fields/common)) q (4192 . 3)) ((c form c (c (? . 0) q tagged-anytag-match!)) q (3216 . 7)) ((c form c (c (? . 0) q tagged-∀-builder!)) q (2058 . 11)) ((c form c (c (? . 0) q tagged-predicate!)) q (2643 . 9)) ((c form c (c (? . 0) q split/type)) q (4483 . 3)) ((c def c (c (? . 0) q TaggedTop-struct)) c (? . 2)) ((c form c (c (? . 0) q tagged-any-fields-type)) q (3781 . 5)) ((c form c (c (? . 0) q tagged-any-predicate!)) q (2426 . 7)) ((c form c (c (? . 0) q check-remembered-node!)) q (1706 . 3)) ((c form c (c (? . 0) q with!!)) q (5083 . 4)) ((c form c (c (? . 0) q tagged-infer-builder!)) q (2291 . 7)) ((c def c (c (? . 1) q to-bits)) q (1110 . 3)) ((c form c (c (? . 0) q tagged-any-fields-predicate)) q (2561 . 5)) ((c form c (c (? . 0) q has-fields/type)) q (4252 . 3)) ((c form c (c (? . 0) q with+)) q (4871 . 4)) ((c form c (c (? . 0) q check-remembered-tagged!)) q (1633 . 3)) ((c form c (c (? . 0) q split)) q (4397 . 3)) ((c form c (c (? . 0) q change-tag)) q (4319 . 3)) ((c form c (c (? . 0) q check-remembered-common!)) q (1560 . 3)) ((c form c (c (? . 0) q tagged-pred-predicate!)) q (2818 . 9)) ((c def c (c (? . 1) q ceiling-log2)) q (1372 . 3)) ((c form c (c (? . 0) q tagged-get-field)) q (3858 . 3)) ((c form c (c (? . 0) q tagged-infer-type!)) q (3649 . 7)) ((c form c (c (? . 0) q tagged-type!)) q (3359 . 7)) ((c def c (c (? . 0) q make-TaggedTop-struct)) c (? . 2)) ((c def c (c (? . 0) q has-fields)) q (3924 . 6)) ((c def c (c (? . 0) q tagged-struct-id?)) q (5195 . 7)) ((c form c (c (? . 0) q check-remembered-?!)) q (1777 . 3)) ((c def c (c (? . 0) q struct:TaggedTop-struct)) c (? . 2)) ((c form c (c (? . 0) q with!)) q (4974 . 4)) ((c form c (c (? . 0) q tagged-builder!)) q (1845 . 11)) ((c form c (c (? . 0) q tagged-∀-type!)) q (3494 . 7)) ((c def c (c (? . 0) q TaggedTop-struct?)) c (? . 2))))
syntax
